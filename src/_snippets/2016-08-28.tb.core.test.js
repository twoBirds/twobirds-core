    ...
    describe("tb() chained", function() {
        ...
        describe(".forEach()", function() {
            ...
            it("forEach()", function() {
                ...
                a.forEach(function(e){
                    e.setProp('testProp', 'testForEach');
                });
        ...
        describe(".getProp()", function() {
            ...
            it("tb('div').get('target')", function() {
                expect( tb('div')[0].getProp('target').tagName === "DIV" ).toBe( true );
            });
        ...
        describe(".setProp()", function() {
            ...
            it("tb('body').setProp('answer', 42 )[0]['answer'] === 42", function() {
                expect( tb('body').setProp('answer', 42 )[0]['answer'] === 42 ).toBe( true );
                delete tb('body')[0]['answer'];
            });

            it("tb('div').setProp('answer', 42 ) all equal 42", function() {
                tb('div').setProp('answer', 42 ); // 5 elements
